...
{
    private Rectangle _circle = new Rectangle(2, 5, 7, 7);
    ...
    public ColorRadioButton() : this(Color.Black, Color.White) { }
    public ColorRadioButton(Color onColor, Color offColor)
    {
        InitializeComponent();
